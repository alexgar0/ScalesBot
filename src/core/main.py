...
async def start() -> None:
    ...
    async with httpx.AsyncClient(timeout=20.0) as client:
        ...
        console.print(Panel.fit("🐉 Agent ready! Type 'exit' or 'quit' to stop.", style="bold green"))
        ...
        while True:
            ...
            with Live(
                ...
                if hasattr(agent, 'run_stream'):
                    ...
                    live.stop()
                    console.print(Panel(Markdown(result.output), 
                                      title="Agent", title_align="left", style="magenta"))
